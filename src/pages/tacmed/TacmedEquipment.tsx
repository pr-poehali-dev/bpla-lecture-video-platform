...
const TOURNIQUETS = [
  ...
  {
    name: "КСТ (Кровоостанавливающий Спасательный Турникет)",
    type: "Российский, механический",
    image: "https://cdn.poehali.dev/projects/7d43b631-9cb0-457c-a9f1-31fabf7fd8fc/files/1b3fe8da-4d3e-40bf-912e-8e4322ef1ddb.jpg",
    badge: "РФ",
    badgeColor: "#ff4444",
    desc: "Российский аналог CAT, разработан для нужд ВС РФ и силовых структур. Лента из стропы с ветрошпилем и фиксатором. Широко применяется в МЧС, Росгвардии и армии РФ.",
    apply: "Обернуть ленту вокруг конечности на 5–7 см выше раны. Затянуть свободный конец через пряжку. Вращать ветрошпиль до остановки кровотечения. Зафиксировать и записать время.",
    pros: ["Доступен в РФ", "Прост в освоении", "Применяется МЧС и силовыми структурами"],
    cons: ["Уступает CAT по надёжности фиксации", "Менее удобен при самоналожении"],
  },
  {
    name: "ТАКТ-1",
    type: "Российский, тактический",
    image: "https://cdn.poehali.dev/projects/7d43b631-9cb0-457c-a9f1-31fabf7fd8fc/files/d9f1fef2-bdf7-4c1a-bfa7-07208cd297bb.jpg",
    badge: "ТАКТ",
    badgeColor: "#ff8c00",
    desc: "Тактический жгут российского производства нового поколения. Широкая лента (4 см), усиленный ветрошпиль из стеклонаполненного полиамида. Разработан с учётом опыта боевых действий.",
    apply: "Надеть петлю на конечность. Протянуть свободный конец через рамочную пряжку и затянуть. Вращать ветрошпиль до остановки кровотечения. Закрепить ветрошпиль в фиксаторе. Записать время.",
    pros: ["Широкая лента — меньше повреждений", "Усиленные материалы", "Отечественное производство"],
    cons: ["Ограниченная доступность", "Требует отработки навыка"],
  },
];
...
const FIRST_AID_KITS = [
  ...
  {
    name: "АКМС (Аптечка Комплектная Медицинская Специальная)",
    level: "Российский, войсковой",
    image: "https://cdn.poehali.dev/projects/7d43b631-9cb0-457c-a9f1-31fabf7fd8fc/files/9c1fcbc8-7af7-490a-86a5-2caedbebe3d7.jpg",
    badge: "АКМС",
    badgeColor: "#ff4444",
    desc: "Штатная индивидуальная аптечка военнослужащего ВС РФ. Носится в подсумке на снаряжении. Рассчитана на само- и взаимопомощь в боевых условиях до эвакуации в медпункт.",
    contents: ["Жгут КСТ или резиновый", "Бинт стерильный большой", "Пакет перевязочный индивидуальный (ППИ)", "Промедол в шприц-тюбике", "Таблетки Пентальгин / Анальгин", "Перчатки резиновые", "Лейкопластырь", "Нашатырный спирт"],
    who: "Каждый военнослужащий ВС РФ",
    weight: "~300–500 г",
  },
  {
    name: "ППМИ (Полевой Пакет Медицинский Индивидуальный)",
    level: "Российский, расширенный",
    image: "https://cdn.poehali.dev/projects/7d43b631-9cb0-457c-a9f1-31fabf7fd8fc/files/59266151-5147-40c3-905e-1ecce7da6dee.jpg",
    badge: "ППМИ",
    badgeColor: "#ff8c00",
    desc: "Расширенный полевой медицинский комплект для санитаров и медиков отделения ВС РФ. Позволяет проводить мероприятия доврачебной помощи на поле боя в рамках протокола ТССС.",
    contents: ["Жгуты КСТ (×2)", "Окклюзионный пластырь (×2)", "Гемостатическая повязка", "Назофарингеальный воздуховод", "Перевязочный пакет ППИ (×3)", "Система в/в инфузии", "Физраствор 500 мл", "Анальгетики", "Ножницы тактические", "Маркер + записная книжка"],
    who: "Санитар / медик отделения",
    weight: "~1,5–3 кг",
  },
];
